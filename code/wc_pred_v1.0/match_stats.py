...
def get_non_feature_columns():
    """ Returns a list of the columns that are in our features dataframe that
        ...
        same game.
    """
    output = ['teamid', 'op_teamid', 'matchid', 'competitionid', 'seasonid',
              'goals', 'op_goals', 'points', 'timestamp', 'team_name', 
              'op_team_name']
    return output
        

def get_feature_columns(all_cols, my_list):
    ...
    """
    return [col for col in all_cols if col not in get_non_feature_columns(my_list)]
